          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="reveal-on-scroll order-1 md:order-2">
              <h1 className="text-3xl md:text-5xl font-bold mb-6 tracking-tight">
                <span className="gradient-text">Seamless Collaboration</span> for your team
              </h1>
              
              <p className="text-lg text-gray-600 mb-8">
                Unite your team with Scriptalis's real-time collaboration tools that make distance irrelevant. Whether working remotely or in the office, keep everyone aligned with shared workspaces, instant messaging, and collaborative document editing.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <p>Real-time document editing and sharing</p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p>Integrated messaging and video conferencing</p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p>Secure file sharing and version control</p>
                </div>
              </div>
